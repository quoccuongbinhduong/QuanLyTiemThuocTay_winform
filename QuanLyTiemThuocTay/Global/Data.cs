...
namespace QuanLyTiemThuocTay.Global
{
    public partial class Data
    {
        ...
        internal static DataGridViewTextBoxColumn MaHoaMD5(DataGridViewTextBoxColumn password)
        {
            throw new NotImplementedException();
        }

        internal static object MaHoaMD5(object v)
        {
            throw new NotImplementedException();
        }
    }
